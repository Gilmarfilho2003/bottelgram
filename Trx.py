...
#password()
print("\n\n\033[1;37Sstart Earning Trx.....!")
try:
    channel_entity = client.get_entity("@Troncoinclick_Bot")
    channel_username = "@Troncoinclick_Bot"
    for i in range(5000000):
        sys.stdout.write("\r")
        sys.stdout.write(
            "                                                              "
        ...
        sys.stdout.flush()
        client.send_message(entity= message="Visit sites")
        sleep(3)
        posts = client(
            GetHistoryRequest(
                peer=channel_entity,
        ...
        if (
            posts.messages[0].message.find("Desculpe, não há novos anúncios disponíveis")
            != -1
        ):
            print("\n\033[1;30m# \033[1;31não realizada..Next\n")
